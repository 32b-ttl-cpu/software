...
#######################################
# toolchain:
PATH_READELF='/opt/xpack-riscv-none-embed-gcc-10.1.0-1.1/bin/riscv-none-embed-readelf'
PATH_OBJDUMP='/opt/xpack-riscv-none-embed-gcc-10.1.0-1.1/bin/riscv-none-embed-objdump'
#######################################
